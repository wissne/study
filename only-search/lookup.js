...
function createPopUp(word,senctence, x, y, screenX, screenY) {
  ...
  if (document.getElementById("voice") != null) {
  	...
  	if (speach_swf.innerHTML != '') {
		speach_swf.innerHTML = insertaudio("http://dict.youdao.com/speech?audio=" + speach_swf.innerHTML, speach_swf.innerHTML, "CLICK", "dictcn_speech");
		...
		if(speach_flash != null)
		{
			...
			{
               //document.embeds['voice_player'].StopPlay(); 
			}
...
//return  '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0" width="15px" height="15px" align="absmiddle" id="speach_flash">' +'<param name="allowScriptAccess" value="sameDomain" />' +'<param name="movie" value="http://cidian.youdao.com/chromeplus/voice.swf" />' +'<param name="loop" value="false" />' +'<param name="menu" value="false" />' +'<param name="quality" value="high" />' +'<param name="wmode"  value="transparent">'+'<param name="FlashVars" value="audio=' + a + '">' +'<embed wmode="transparent" src="http://cidian.youdao.com/chromeplus/voice.swf" loop="false" menu="false" quality="high" bgcolor="#ffffff" width="15" height="15" align="absmiddle" allowScriptAccess="sameDomain" FlashVars="audio=' + a + '" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" id = "voice_player"/>' +'</object>' ;
return '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" id="speach_flash" style="width:15px;height:15px;" align="absmiddle" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="15" height="15" ><param name="movie" value="http://dict.youdao.com/test.nobound.swf?audio=http://dict.youdao.com/speach?audio='+query+'"><embed src="http://dict.youdao.com/test.nobound.swf?audio=http://dict.youdao.com/speach?audio='+query+'" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="15" height="15" swliveconnect="true" id="tranSondSwf" name="tranSondSwf" allowscriptaccess="always"><param name="quality" value="high"></object>';
